...
import { exportProducts, loadProductsPage } from "../lib/actions";
...
export default function ProductsPage() {
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      do {
        const page: { items: ProductSummary[]; hasNextPage: boolean; endCursor: string | null } = await loadProductsPage(cursor);
  ...
  async function exportSelection(format: "xlsx" | "csv") {
    ...
    try {
      ...
      const name = await exportProducts({ format, ids: ids.length !== products.length ? ids : undefined });
  ...
  return (
    <div className="gl-page">
      <div className="gl-head">
        ...
        <NavLink to="import" className="gl-btn">⬆ Import Excel</NavLink>
